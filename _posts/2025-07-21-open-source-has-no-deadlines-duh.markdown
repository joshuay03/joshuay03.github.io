...
full-time job as a software engineer, approaching the end of my six-month probation period. I was settling in,
contributing to some decently sized projects and generally getting the hang of things. But despite that, I was getting
bored.
...
At some point, one of the founders of the company I was working for, who was also a member of the Rails Issues team,
noticed my pull request and shared it in the company chat. He mentioned that there was a Discord server where I could
ask for a review if my pull request had been open for a while.
...
my pull request, or any bug fix pull request for that matter, wasn't merged within a week. I was so wrong. I was so
naïve.
